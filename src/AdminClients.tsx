  ...
  return (
    <div className="space-y-12">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        ...
        <button
          onClick={() => { setEditingClient(null); setFormData({ name: '', contact: '', notes: '' }); setShowModal(true); }}
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-white/5">
              {filtered.length === 0 && (
                <tr>
                  <td colSpan={4} className="px-8 py-16 text-center text-slate-600 font-medium">
              ...
              {filtered.map(client => (
                <tr key={client.id} className="hover:bg-white/[0.02] transition-colors group">
                  ...
                  <td className="px-8 py-6">
                    <p className="text-sm text-slate-500 truncate max-w-xs font-light italic">
          ...
          <div className="fixed inset-0 bg-black/80 backdrop-blur-xl z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-2">Contato</label>
                  <input
                    required
                    type="text"
                    placeholder="telefone, email, whatsapp..."
                    className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white outline-none focus:border-indigo-500 transition-colors"
